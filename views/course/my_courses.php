...
<div class="container">
    ...
    <!-- Form tìm kiếm -->
    <form class="mb-4" id="courseFilterForm" method="GET" action="/study_sharing/course/myCourses">
        <div class="row g-3">
            <div class="col-md-6">
    ...
    <?php if (empty($courses)): ?>
        <div class="alert alert-info">Bạn chưa tham gia khóa học nào.</div>
    <?php else: ?>
                ...
                <div class="col">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text"><small class="text-muted">Trạng thái:
                                    <?php
