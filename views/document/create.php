...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary fs-3 fw-bold"><i class="bi bi-file-earmark-text me-2"></i>Tải lên tài liệu mới</h1>
        <a href="/study_sharing/document/manage" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left me-1"></i>Quản lý tài liệu</a>
    </div>
