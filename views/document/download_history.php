...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0">Lịch sử tải tài liệu</h1>
    </div>

    <!-- Filter Section -->
    <div class="filter-section">
        <form id="documentFilterForm" method="GET" action="/study_sharing/document/downloadHistory">
            <div class="row g-3">
                <div class="col-md-6">
    ...
    <?php if (empty($documents)): ?>
        <div class="empty-state">
            ...
            <p class="text-muted">Bạn chưa tải tài liệu nào.</p>
        </div>
    <?php else: ?>
                    ...
                    <div class="card document-card h-100">
                        <div class="card-body">
                            ...
                            if (isset($doc['file_type'])) {
                                ...
                                elseif ($doc['file_type'] === 'doc' || $doc['file_type'] === 'docx') $fileIconClass = 'bi-file-earmark-word docx';
                                elseif ($doc['file_type'] === 'ppt' || $doc['file_type'] === 'pptx') $fileIconClass = 'bi-file-earmark-ppt pptx';
                            }
                            ?>
                            ...
                            <div class="document-meta">
                                ...
                                <?php if (!empty($doc['course_name'])): ?>
                                    <div><i class="bi bi-book"></i> <a href="/study_sharing/course/detail/<?php echo $doc['course_id']; ?>"><?php echo htmlspecialchars($doc['course_name']); ?></a></div>
                                <?php endif; ?>
                                ...
                                <div><i class="bi bi-download"></i> <?php echo date('d/m/Y H:i', strtotime($doc['download_date'])); ?></div>
                            </div>
