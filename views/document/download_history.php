...
<div class="container">
    <h1 class="mb-4">Lịch sử tải tài liệu</h1>

    <!-- Form tìm kiếm và lọc -->
    <form class="mb-4" id="documentFilterForm" method="GET" action="/study_sharing/document/downloadHistory">
        <div class="row g-3">
            <div class="col-md-6">
    ...
    <?php if (empty($documents)): ?>
        <div class="alert alert-info">Bạn chưa tải tài liệu nào.</div>
    <?php else: ?>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <?php if (!empty($doc['course_name'])): ?>
                                <p class="card-text"><small class="text-muted">Khóa học: <a class="text-decoration-none" href="/study_sharing/course/detail/<?php echo $doc['course_id']; ?>"><?php echo htmlspecialchars($doc['course_name']); ?></a></small></p>
                            <?php endif; ?>
                            <p class="card-text"><small class="text-muted">Người tải lên: <?php echo htmlspecialchars($doc['full_name'] ?? 'Ẩn danh'); ?></small></p>
                            <p class="card-text"><small class="text-muted">Ngày tải lên: <?php echo date('d/m/Y', strtotime($doc['upload_date'])); ?></small></p>
                            <p class="card-text"><small class="text-muted">Ngày tải xuống: <?php echo date('d/m/Y H:i', strtotime($doc['download_date'])); ?></small></p>
                            <p class="card-text">
